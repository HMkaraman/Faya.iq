...
export default function NewOfferPage() {
  ...
  async function handleSubmit(data: OfferFormData) {
    ...
    try {
      ...
      if (!res.ok) { const err = await res.json(); throw new Error(err.error || "Failed to create offer"); }
  ...
  return (
    <>
      <TopBar title="Add Offer" breadcrumbs={[{ label: "Offers", href: "/admin/offers" }, { label: "New Offer" }]}>
