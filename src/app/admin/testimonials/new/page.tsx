...
export default function NewTestimonialPage() {
  ...
  return (
    <>
      <TopBar title={t(adminI18n.testimonials.addTestimonial)} breadcrumbs={[{ label: t(adminI18n.testimonials.title), href: "/admin/testimonials" }, { label: t(adminI18n.testimonials.newTestimonial) }]}>
