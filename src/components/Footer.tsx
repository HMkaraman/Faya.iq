  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-8 sm:p-12 mb-16">
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              <input
                ...
                required
                className="flex-1 px-5 py-3 rounded-full border border-[#f1eaec] bg-white text-[#333333] placeholder-[#8c7284]/60 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
              />
              <button
                type="submit"
                className="px-8 py-3 rounded-full bg-primary text-white font-semibold hover:bg-[#b34a6e] active:bg-[#a04162] transition-colors cursor-pointer shrink-0"
              >
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                aria-label="Facebook"
                className="w-10 h-10 rounded-full border border-[#f1eaec] bg-white flex items-center justify-center text-[#8c7284] hover:bg-primary hover:border-primary hover:text-white transition-all duration-200"
              >
            ...
            <ul className="space-y-3">
              {treatmentLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#8c7284] text-sm hover:text-primary transition-colors"
                  >
                    {t(link.label)}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className="text-[#8c7284] text-sm group-hover:text-primary transition-colors"
                    dir="ltr"
                  >
                    +964 770 000 0000
                  </span>
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-[#8c7284] text-sm group-hover:text-primary transition-colors">
                    info@faya.iq
                  </span>
                </a>
              </li>
